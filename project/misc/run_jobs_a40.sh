...
common_train_args="--img_size 224 --model ${model} --hash_length 64 --quantization_weight 0.0001 --no-scale_the_outputs --bias --num_workers 32 --batch_size 256 --max_epochs 50 --weight_decay 0.0005 --learning_rate 0.05 --task ${task} --logs_dir ${logs_dir} --experiment_name ${experiment_name} --dataset_dir ${dataset_dir} --dataset_name ${dataset_name}"
