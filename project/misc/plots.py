...
def compare_methods_with_noisy_test():
    ...
    exp1_name = 'push3_pull3_avg3_inhibition1'
    ...
    exp2_name = 'push3_pull5_avg0_inhibition1'
    ...
    exp3_name = 'push3_pull5_avg3_inhibition1'
    ...
    exp4_name = 'push5_pull5_avg3_inhibition1'
    ...
    exp5_name = 'push5_pull5_avg5_inhibition1'
    ...
    exp6_name = 'push5_pull5_avg0_inhibition1'
    ...
    exp7_name = 'push3_pull3_avg0_inhibition1'
    ...
    plt.figure()
    plt.plot(baseline_ConvNet['std_dev'], baseline_ConvNet['mAP_score'], label='baseline_conv5x5')
